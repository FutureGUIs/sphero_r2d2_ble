...
PLATFORMS = ["sensor", "binary_sensor", "button", "select", "light", "number"]
...
ANIMATRONIC_DEVICE_ID = 0x17
ANIMATRONIC_SET_HEAD_POSITION = 0x0F

HEAD_POSITION_MIN = -160
HEAD_POSITION_MAX = 180
...
R2_LED_FRONT_BLUE = 2
R2_LED_LOGIC_DISPLAYS = 3
R2_LED_BACK_RED = 4
R2_LED_BACK_GREEN = 5
R2_LED_BACK_BLUE = 6
R2_LED_HOLO_PROJECTOR = 7
